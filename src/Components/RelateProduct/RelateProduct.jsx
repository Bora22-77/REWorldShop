...
const RelateProduct = () => {
  ...
  return (
    <div className='max-w-8xl max-auto px-5 py-12 space-y-12'>
        <hr />
        <h1 className='text-7xl justify-center text-center font-bold bg-gradient-to-r from-green-800 via-gray-500 to-yellow-200 bg-clip-text text-transparent'> Products</h1>
